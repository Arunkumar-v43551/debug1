...
# BUG 8: This creates circular dependency with module
from module_b import log_analytics
# BUG 9: Wrong import - should use state.increment_count()
from state import increment_count # Wrong! Should import function, not variable
...
def add_user():
    ...
    increment_count()  # This doesn't work!
